function paginaCargada(){
    ...
    //        listaCarrito.innerHTML += '<img src="' + producto.imagen + '" width="50">' + producto.titulo;
        });
    }
    ...
    //function recorrerBotones(boton){
      //  function agregarAlCarrito(){
        //    var padre = boton.parentNode;
          //  var titulo = padre.querySelector('.producto__titulo').innerText;
...
/*
    ...
    function agregarAlCarritoDetalle(){
        var titulo = document.querySelector('.producto__titulo').innerText;
